...
When the global convergence has been reached, it is possible to generate a new random density normal distribution and then the algorithm is ran again to achieve a new final configuration.\\
