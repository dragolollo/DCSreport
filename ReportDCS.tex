...
Reading the Mathlab code, it is easy to see that before the parallel part, the \textbf{offline} algorithm is ran and its result is visualized in order to make a comparison between the 2 versions.
