...
Finally, the algorithm stops when every agents has reached a distance from its cell centroid lower than a given threshold.\\	
	...
	We have negletted a little bit optimization problems from the code efficiency point of view, nonetheless the execution times seem to be reasonably short.\\
	So we think that the algortihm can be improved in terms of code optimization and task communication efficiency.\\
	% %%%% APPENDIX %%%%%
	% \appendix
